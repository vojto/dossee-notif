...
function Server(o) {
  ...
  if(o && o.secure && !(o.hasOwnProperty('key') && o.hasOwnProperty('cert'))) {	
    throw new Error("You have provided the 'secure' option, however it also requires 'key' and 'cert' options, which were not provided");
  }

  var secureOptions = (o && o.secure) ? { key: o.key, cert: o.cert } : null;

  var options = Mixin({
    debug: false,
    server: new ((o && o.secure || false) ? https : http).Server(secureOptions)
  }, o);
